(function (sandbox) {
	...
	this.invokeFunPre = function (iid, f, base, args, isConstructor) {
	    console.log("Inside the invokeFunPre invoked at "+iid);
            invokedAtIid = iid;
        }
	...
	this.functionEnter = function (iid, fun, dis /* this */, args) {
            ...
            callStack.push(iid);
	    callTrace.push(iid);
	    console.log("Enter: Function name : "+iidToFunName[iid]+ ", defined at location: "+J$.iids['originalCodeFileName']+", having a unique IID of: "+iid+', and its source map is: ['+J$.iids[iid]+']');
        }
